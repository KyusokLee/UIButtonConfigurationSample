...
class ViewController: UIViewController {
    ...
    private lazy var firstCheckButton: UIButton = {
        ...
        button.setTitle("チェックボタンその１", for: .normal)
...
//        config.contentInsets = NSDirectionalEdgeInsets(top: 15, leading: 7, bottom: 15, trailing: 0)
